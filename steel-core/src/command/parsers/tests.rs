...
use crate::{
    ...
    command::{
        ...
        parsers::{
            ...
            NbtCompoundParser, NbtPathParser, ObjectiveParser, PermissionGroupParser,
            ...
            Vec3Parser, WorldArgumentValue, WorldParser, parse_resource_identifier,
        },
...
mod permission {
    ...
    fn permission_management_parsers_request_server_suggestions() {
        ...
        let (_, group_suggestion) = PermissionGroupParser
            .client_parser()
            .into_protocol_argument();
...
mod resource {
    ...
    fn resource_identifier_helper_uses_vanilla_default_namespace() {
        assert_eq!(
            parse_resource_identifier("stone"),
        ...
        assert_eq!(
            parse_resource_identifier("steel:data"),
            Some(Identifier::new_static("steel", "data"))
        );
        assert!(parse_resource_identifier("Steel:data").is_none());
    }
